                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                    ...
                    <div>
                        ...
                        <ul>
                            ...
                            <li className="mb-2"><Link href="#" className="hover:text-[#5D008F]">Tienda</Link></li>
                            <li className="mb-2"><Link href="#" className="hover:text-[#5D008F]">Cartas</Link></li>
                        </ul>
                    </div>
                    ...
                    <div>
                        ...
                        <ul>
                            <li className="mb-2"><Link href="#" className="hover:text-[#5D008F]">Política de privacidad</Link></li>
                            <li className="mb-2"><Link href="#" className="hover:text-[#5D008F]">Términos y condiciones</Link></li>
                            <li className="mb-2"><Link href="#" className="hover:text-[#5D008F]">Política de cookies</Link></li>
                        </ul>
                    </div>
